-- Hardening RLS creazione negozio.
-- Consente a un utente autenticato di creare SOLO il proprio negozio
-- come draft/pending non pubblico. L'approvazione resta admin/manager.
...
revoke execute on function public.auto_link_shop_manager_on_insert()
from public, anon, authenticated;
grant execute on function public.auto_link_shop_manager_on_insert()
to service_role;
